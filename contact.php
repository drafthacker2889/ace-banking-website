    ...
    <div class="flex-container-background">
        ...
        <div class="flex-container" style="border-bottom: 0;
            ...
            <div class="flex-item">
                ...
                <p id="sub-contact">
                    Corporate HQ<br>Ace Bank<br>
                    French Cedar Bridge Avenue, kochi<br>
                    Kerala, India
                </p>
            </div>
            <div class="flex-item">
                ...
                <p id="sub-contact">
                    Toll-Free: 999-888-7777<br>
                    Phone: 906-100-9602<br>
                    Fax: 2090-888-6969<br>
                    Email: office@&#8203acebank.com
                </p>
            </div>
        </div>
        ...
        <div class="flex-container" style="border-top: 0;
            ...
            <div class="flex-item">
                ...
                <p id="sub-contact">
                    ...
                    Email: customercare@&#8203acebank.com
                </p>
            </div>
            <div class="flex-item">
